              ...
              <DialogContent className="bg-card border-white/10 text-white max-w-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label>Rating (0-5, decimals allowed)</Label>
                      <Input
                        type="number"
                        min="0"
                        max="5"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="https://discord.gg/N2jgE7Azpf"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  https://discord.gg/N2jgE7Azpf
                </a>
                <a
                  href="https://t.me/puretickets"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm text-muted-foreground hover:text-[#0088cc] transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
